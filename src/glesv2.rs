...
pub type GLbitfield = uint32_t;
pub type GLboolean  = c_uchar;
pub type GLbyte     = khronos_int8_t;
pub type GLchar     = c_char;
pub type GLclampf   = khronos_float_t;
pub type GLenum     = uint32_t;
pub type GLfixed    = khronos_int32_t;
pub type GLfloat    = khronos_float_t;
pub type GLint      = int32_t;
pub type GLshort    = int16_t;
pub type GLsizei    = int32_t;
pub type GLubyte    = khronos_uint8_t;
pub type GLuint     = uint32_t;
pub type GLushort   = uint16_t;
